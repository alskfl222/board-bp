  ...
  (editorRef: React.MutableRefObject<any>) => () => {
    ...
    ytButton.onclick = () => {
      ...
      editorRef.current
        ...
        .setHTML(
          existHTML +
            `<div><iframe width="560" height="315" src="https://www.youtube.com/embed/${youtubeId}" title="Youtube player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br></div><p></p>`
        );
      ytInput.value = '';
    };
